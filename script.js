...
// && - и
// || - или
// функцию можно написать полность function name (arg1, arg2, arg3) {} 
// либо стрелочно (arg1, arg2, arg3) => {} 
// или в случае одного аргумента можно написать arg1 => {}


// MVC:
// Model = данные
// View = вид, отображение, представление (каким образом пользователь эти данные видит)
// Controller = управление этими данными, манипуляция
